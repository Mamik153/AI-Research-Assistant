...
import type { ErrorBoundaryState } from "@/shared/types";
...
> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      // Default fallback UI
      return (
        <div className="error-boundary overflow-hidden">
          <div className="error-boundary__container">
            ...
            <div className="error-boundary__content">
              ...
              <p className="error-boundary__message">
                The AI Research Assistant encountered an unexpected error. This
              ...
              <div className="error-boundary__help">
                ...
                <ul className="error-boundary__help-list">
                  ...
                  <li>Ensuring the research service is running</li>
                </ul>
              </div>
            </div>
          </div>
