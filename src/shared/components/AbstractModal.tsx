...
export const AbstractModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-3xl max-h-[85vh] flex flex-col bg-white backdrop-blur-sm text-gray-100 p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-4 border-b border-gray-300 space-y-4">
        ...
        <ScrollArea className="flex-1 px-6 py-4 h-[300px] overflow-y-auto">
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-gray-500 leading-relaxed whitespace-pre-line text-base">
              {paper.summary}
            </p>
          </div>
        </ScrollArea>

        <DialogFooter className="p-4 border-t border-gray-300 flex-row items-center justify-between gap-4">
