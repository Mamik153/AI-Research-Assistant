    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {applications.map((item, idx) => (
          <div
            key={idx}
            className="p-4 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 transition group shadow-sm hover:bg-white/10 min-w-0"
          >
            <h4 className="font-medium text-white/90 transition text-lg break-words">
              {item.title}
            </h4>
