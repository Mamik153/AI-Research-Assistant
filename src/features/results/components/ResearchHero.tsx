...
export const ResearchHero = ({ result }: ResearchHeroProps) => {
  ...
  return (
    <div className="w-full mb-8 relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 to-black border border-gray-800 p-4 sm:p-6 lg:p-8">
      ...
      <div className="relative z-10 w-full min-w-0 max-w-full">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 min-w-0">
          <div className="space-y-4 min-w-0 flex-1">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-gray-200 to-gray-400 tracking-tight leading-tight break-words min-w-0">
              {result.topic}
            </h2>
          </div>
        </div>
