    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {keyConcepts.map((concept, idx) => (
          <div
            key={idx}
            className="p-4 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-sm hover:bg-white/10 transition group min-w-0"
          >
            <h4 className="font-medium text-xl text-white/90 transition break-words">
              {concept.name}
            </h4>
