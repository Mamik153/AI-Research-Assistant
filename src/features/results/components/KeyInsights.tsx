      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {insights.map((insight: string, idx: number) => (
          <motion.div
            ...
            className="group p-5 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-sm hover:bg-white/10 transition-all duration-300 relative overflow-hidden h-full min-w-0"
          >
            ...
            <div className="flex gap-4 min-w-0">
              ...
              <p className="text-white/90 transition-colors leading-relaxed text-lg break-words min-w-0">
                {insight}
              </p>
            </div>
          </motion.div>
