    ...
    if (currentListItems.length > 0) {
      elements.push(
        <ul
          ...
          className="research-result__report-list"
        >
    ...
    if (codeBlockContent.length > 0) {
      elements.push(
        <pre
          ...
          className="research-result__report-code-block"
        >
  ...
  lines.forEach((line, index) => {
    ...
    if (line.match(/^\d+\.\s/)) {
      ...
      if (currentListItems.length === 0) {
        ...
        elements.push(
          <ol
            key={`ol-${index}`}
            className="research-result__report-ordered-list"
          >
    ...
    if (line.startsWith("> ")) {
      ...
      elements.push(
        <blockquote
          key={`quote-${index}`}
          className="research-result__report-blockquote"
        >
          {renderInlineMarkdown(text)}
        </blockquote>,
      );
  ...
  currentText = currentText.replace(/`([^`]+)`/g, (_, code) => {
    ...
    elements.push(
      <code
        ...
        className="research-result__report-inline-code"
      >
        {code}
      </code>,
    );
  ...
  currentText = currentText.replace(/\*\*([^*]+)\*\*/g, (_, boldText) => {
    ...
    elements.push(
      <strong
        ...
        className="research-result__report-bold"
      >
        {boldText}
      </strong>,
    );
  ...
  currentText = currentText.replace(/\*([^*]+)\*/g, (_, italicText) => {
    ...
    elements.push(
      <em
        ...
        className="research-result__report-italic"
      >
        {italicText}
      </em>,
    );
    ...
    <div className="research-result">
      <div className="research-result__header hidden">
        <div className="research-result__status-badge">
          ...
          <span className="research-result__status-text">
            Research Complete
          </span>
        </div>
        ...
        <div className="research-result__metadata">
          ...
          <div className="research-result__details">
            <div className="research-result__detail-item">
              ...
              <code className="research-result__detail-value">
                {result.jobId}
              </code>
            </div>
            <div className="research-result__detail-item">
